...
const registerUser = (nameStr, emailStr, phoneStr, passwordStr) => {
...
try {
    const newUser = registerUser('Alice Johnson', 'alice@example.com', '0612345678', 'secret123');
